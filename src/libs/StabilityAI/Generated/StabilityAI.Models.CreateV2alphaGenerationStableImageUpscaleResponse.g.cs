...
namespace StabilityAI
{
    ...
    public sealed partial class CreateV2alphaGenerationStableImageUpscaleResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateV2alphaGenerationStableImageUpscaleResponse" /> class.
        /// </summary>
        /// <param name="id">
        /// The `id` of a generation, typically used for async generations, that can be used to check the status of the generation or retrieve the result.<br/>
        /// Example: a6dc6c6e20acda010fe14d71f180658f2896ed9b4ec25aa99a6ff06c796987c4
...
#endif
        public CreateV2alphaGenerationStableImageUpscaleResponse(
            string id)
        {
