...
namespace StabilityAI
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_CreateStableImageGenerateCoreAsBytesSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_CreateStableImageGenerateCoreAsBytesSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_CreateStableImageGenerateCoreAsBytesSecurityRequirement0,
            };
        partial void PrepareCreateStableImageGenerateCoreAsBytesArguments(
        ...
        partial void PrepareCreateStableImageGenerateCoreAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::StabilityAI.CreateStableImageGenerateCoreRequest request);
        partial void ProcessCreateStableImageGenerateCoreAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStableImageGenerateCoreAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> CreateStableImageGenerateCoreAsBytesAsync(
            string contentType,
        ...
        {
            var __response = await CreateStableImageGenerateCoreAsBytesAsResponseAsync(
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateStableImageGenerateCoreAsBytesAsStreamAsync(
            string contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStableImageGenerateCoreAsBytesArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStableImageGenerateCoreAsBytesSecurityRequirements,
            ...
            if (stabilityClientVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStableImageGenerateCoreAsBytesRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createStableImageGenerateCoreAsBytes",
                                methodName: "CreateStableImageGenerateCoreAsBytesAsync",
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<byte[]>> CreateStableImageGenerateCoreAsBytesAsResponseAsync(
            string contentType,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageGenerateCoreAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateStableImageGenerateCoreAsBytesAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
