...
{
    /// <summary>
    /// Example: {"id":"4212a4b66fbe1cedca4bf2133d35dca5","name":"payload_too_large","errors":["body: payloads cannot be larger than 10MiB in size"]}
    /// </summary>
    public sealed partial class CreateStableImageEditRemoveBackgroundResponse4
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStableImageEditRemoveBackgroundResponse4" /> class.
        /// </summary>
        /// <param name="id">
        /// A unique identifier associated with this error. Please include this in any [support tickets](https://kb.stability.ai/knowledge-base/kb-tickets/new)<br/>
        /// you file, as it will greatly assist us in diagnosing the root cause of the problem.<br/>
...
#endif
        public CreateStableImageEditRemoveBackgroundResponse4(
            string id,
            string name,
