...
namespace StabilityAI
{
    public partial class ControlClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_CreateStableImageControlStyleTransferSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_CreateStableImageControlStyleTransferSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_CreateStableImageControlStyleTransferSecurityRequirement0,
            };
        partial void PrepareCreateStableImageControlStyleTransferArguments(
        ...
        partial void PrepareCreateStableImageControlStyleTransferRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::StabilityAI.CreateStableImageControlStyleTransferRequest request);
        partial void ProcessCreateStableImageControlStyleTransferResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStableImageControlStyleTransferResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateStableImageControlStyleTransferAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStableImageControlStyleTransferArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStableImageControlStyleTransferSecurityRequirements,
                operationName: "CreateStableImageControlStyleTransferAsync");
            ...
            if (stabilityClientVersion != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("stability-client-version", stabilityClientVersion.ToString());
                            ...
                            var __contentStyleImage = new global::System.Net.Http.ByteArrayContent(request.StyleImage ?? global::System.Array.Empty<byte>());
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStableImageControlStyleTransferRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createStableImageControlStyleTransfer",
                                methodName: "CreateStableImageControlStyleTransferAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateStableImageControlStyleTransferResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageControlStyleTransferResponse4>(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageControlStyleTransferResponse5>(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageControlStyleTransferResponse6>(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageControlStyleTransferResponse7>(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageControlStyleTransferResponse8>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageControlStyleTransferResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateStableImageControlStyleTransferAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::StabilityAI.CreateStableImageControlStyleTransferRequest
            {
                ...
                InitImagename = initImagename,
                StyleImage = global::System.Array.Empty<byte>(),
                StyleImagename = styleImagename,
                Prompt = prompt,
                NegativePrompt = negativePrompt,
                Seed = seed,
