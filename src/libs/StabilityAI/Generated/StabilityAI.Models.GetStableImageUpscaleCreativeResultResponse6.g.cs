...
{
    /// <summary>
    /// Example: {"id":"2bca35116bc5431d6dc4b4ea2ef3da2f","name":"generation_not_found","errors":["id: the generation either does not exist or has expired."]}
    /// </summary>
    public sealed partial class GetStableImageUpscaleCreativeResultResponse6
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStableImageUpscaleCreativeResultResponse6" /> class.
        /// </summary>
        /// <param name="id">
        /// A unique identifier associated with this error. Please include this in any [support tickets](https://kb.stability.ai/knowledge-base/kb-tickets/new)<br/>
        /// you file, as it will greatly assist us in diagnosing the root cause of the problem.<br/>
...
#endif
        public GetStableImageUpscaleCreativeResultResponse6(
            string id,
            string name,
