...
namespace StabilityAI
{
    public partial class V1GenerationClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_UpscaleImageAsBytesSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_UpscaleImageAsBytesSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_UpscaleImageAsBytesSecurityRequirement0,
            };
        partial void PrepareUpscaleImageAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string engineId,
            ref global::StabilityAI.UpscaleImageAccept? accept,
            ref string? organization,
            global::StabilityAI.UpscaleImageRequestBody request);
        partial void PrepareUpscaleImageAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string engineId,
            global::StabilityAI.UpscaleImageAccept? accept,
            string? organization,
            global::StabilityAI.UpscaleImageRequestBody request);
        partial void ProcessUpscaleImageAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpscaleImageAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        ///   -o "$OUTPUT_FILE"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> UpscaleImageAsBytesAsync(
            string engineId,
        ...
        {
            var __response = await UpscaleImageAsBytesAsResponseAsync(
                engineId: engineId,
        ...
        ///   -o "$OUTPUT_FILE"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> UpscaleImageAsBytesAsStreamAsync(
            string engineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpscaleImageAsBytesArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpscaleImageAsBytesSecurityRequirements,
                operationName: "UpscaleImageAsBytesAsync");
            ...
            if (organization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpscaleImageAsBytesRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpscaleImageAsBytes",
                                methodName: "UpscaleImageAsBytesAsync",
                                pathTemplate: "$\"/v1/generation/{engineId}/image-to-image/upscale\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::StabilityAI.Error? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::StabilityAI.Error.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::StabilityAI.Error? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::StabilityAI.Error.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
        ...
        ///   -o "$OUTPUT_FILE"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<byte[]>> UpscaleImageAsBytesAsResponseAsync(
            string engineId,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpscaleImageAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpscaleImageAsBytesAsync(
                engineId: engineId,
                accept: accept,
                organization: organization,
                request: __request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::StabilityAI.UpscaleImageRequestBody
            {
