...
namespace StabilityAI
{
    ...
    public sealed partial class CreateV2alphaGenerationStableImageInpaintResponse5
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateV2alphaGenerationStableImageInpaintResponse5" /> class.
        /// </summary>
        /// <param name="id">
        /// A unique identifier associated with this error. Please include this in any [support tickets](https://kb.stability.ai/knowledge-base/kb-tickets/new)<br/>
        /// you file, as it will greatly assist us in diagnosing the root cause of the problem.<br/>
...
#endif
        public CreateV2alphaGenerationStableImageInpaintResponse5(
            string id,
            string name,
