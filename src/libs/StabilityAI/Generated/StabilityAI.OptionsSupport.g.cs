...
namespace StabilityAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::StabilityAI.AutoSDKRetryOptions Retry { get; set; } = new global::StabilityAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::StabilityAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::StabilityAI.IAutoSDKHook>();
        ...
        public global::StabilityAI.AutoSDKClientOptions AddHook(
            global::StabilityAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::StabilityAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::StabilityAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::StabilityAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::StabilityAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::StabilityAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::StabilityAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::StabilityAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::StabilityAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::StabilityAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::StabilityAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::StabilityAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::StabilityAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::StabilityAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::StabilityAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::StabilityAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::StabilityAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::StabilityAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::StabilityAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::StabilityAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::StabilityAI.AutoSDKClientOptions clientOptions,
            global::StabilityAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::StabilityAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::StabilityAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::StabilityAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::StabilityAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::StabilityAI.IAutoSDKHook, global::StabilityAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::StabilityAI.AutoSDKHookContext context)
        {
