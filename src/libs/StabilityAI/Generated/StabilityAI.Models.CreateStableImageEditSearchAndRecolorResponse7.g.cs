...
{
    /// <summary>
    /// Example: {"id":"rate_limit_exceeded","name":"rate_limit_exceeded","errors":["You have exceeded the rate limit of 150 requests within a 10 second period, and have been timed out for 60 seconds."]}
    /// </summary>
    public sealed partial class CreateStableImageEditSearchAndRecolorResponse7
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStableImageEditSearchAndRecolorResponse7" /> class.
        /// </summary>
        /// <param name="id">
        /// A unique identifier associated with this error. Please include this in any [support tickets](https://kb.stability.ai/knowledge-base/kb-tickets/new)<br/>
        /// you file, as it will greatly assist us in diagnosing the root cause of the problem.<br/>
...
#endif
        public CreateStableImageEditSearchAndRecolorResponse7(
            string id,
            string name,
