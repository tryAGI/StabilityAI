...
namespace StabilityAI
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_CreateStableImageGenerateCoreSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_CreateStableImageGenerateCoreSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_CreateStableImageGenerateCoreSecurityRequirement0,
            };
        partial void PrepareCreateStableImageGenerateCoreArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contentType,
            ref global::StabilityAI.CreateStableImageGenerateCoreAccept? accept,
        ...
        partial void PrepareCreateStableImageGenerateCoreRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string contentType,
            global::StabilityAI.CreateStableImageGenerateCoreAccept? accept,
            string? stabilityClientId,
            string? stabilityClientUserId,
            string? stabilityClientVersion,
            global::StabilityAI.CreateStableImageGenerateCoreRequest request);
        partial void ProcessCreateStableImageGenerateCoreResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStableImageGenerateCoreResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Stable Image Core<br/>
        /// Our primary service for text-to-image generation, Stable Image Core represents the best quality achievable at high<br/>
        /// speed. No prompt engineering is required! Try asking for a style, a scene, or a character, and see what you get.<br/>
        /// ### Try it out<br/>
        ...
        /// ### Output<br/>
        /// The resolution of the generated image will be 1.5 megapixels.<br/>
        /// ### Credits<br/>
        ...
        ///     f"https://api.stability.ai/v2beta/stable-image/generate/core",<br/>
        ///     headers={<br/>
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.CreateStableImageGenerateCoreResponse> CreateStableImageGenerateCoreAsync(
            string contentType,
        ...
        {
            var __response = await CreateStableImageGenerateCoreAsResponseAsync(
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.CreateStableImageGenerateCoreResponse>> CreateStableImageGenerateCoreAsResponseAsync(
            string contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStableImageGenerateCoreArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStableImageGenerateCoreSecurityRequirements,
                operationName: "CreateStableImageGenerateCoreAsync");
            ...
            if (stabilityClientVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStableImageGenerateCoreRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createStableImageGenerateCore",
                                methodName: "CreateStableImageGenerateCoreAsync",
                                pathTemplate: "\"/v2beta/stable-image/generate/core\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateStableImageGenerateCoreResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::StabilityAI.CreateStableImageGenerateCoreResponse4? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::StabilityAI.CreateStableImageGenerateCoreResponse4.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageGenerateCoreResponse4>.Create(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::StabilityAI.CreateStableImageGenerateCoreResponse5? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::StabilityAI.CreateStableImageGenerateCoreResponse5.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageGenerateCoreResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::StabilityAI.CreateStableImageGenerateCoreResponse6? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::StabilityAI.CreateStableImageGenerateCoreResponse6.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageGenerateCoreResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::StabilityAI.CreateStableImageGenerateCoreResponse7? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::StabilityAI.CreateStableImageGenerateCoreResponse7.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageGenerateCoreResponse7>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageGenerateCoreResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::StabilityAI.CreateStableImageGenerateCoreResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.CreateStableImageGenerateCoreResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::StabilityAI.CreateStableImageGenerateCoreResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::StabilityAI.CreateStableImageGenerateCoreResponse> CreateStableImageGenerateCoreAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::StabilityAI.CreateStableImageGenerateCoreRequest
            {
                Prompt = prompt,
            ...
            return await CreateStableImageGenerateCoreAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
