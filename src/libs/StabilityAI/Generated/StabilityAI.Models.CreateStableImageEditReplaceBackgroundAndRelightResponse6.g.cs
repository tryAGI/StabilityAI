...
{
    /// <summary>
    /// Example: {"id":"2a1b2d4eafe2bc6ab4cd4d5c6133f513","name":"internal_error","errors":["An unexpected server error has occurred, please try again later."]}
    /// </summary>
    public sealed partial class CreateStableImageEditReplaceBackgroundAndRelightResponse6
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStableImageEditReplaceBackgroundAndRelightResponse6" /> class.
        /// </summary>
        /// <param name="id">
        /// A unique identifier associated with this error. Please include this in any [support tickets](https://kb.stability.ai/knowledge-base/kb-tickets/new)<br/>
        /// you file, as it will greatly assist us in diagnosing the root cause of the problem.<br/>
...
#endif
        public CreateStableImageEditReplaceBackgroundAndRelightResponse6(
            string id,
            string name,
