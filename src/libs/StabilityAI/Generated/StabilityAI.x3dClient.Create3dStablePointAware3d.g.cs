...
{
    public partial class x3dClient
    {


        private static readonly global::StabilityAI.EndPointSecurityRequirement s_Create3dStablePointAware3dSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_Create3dStablePointAware3dSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_Create3dStablePointAware3dSecurityRequirement0,
            };
        partial void PrepareCreate3dStablePointAware3dArguments(
        ...
        partial void PrepareCreate3dStablePointAware3dRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::StabilityAI.Create3dStablePointAware3dRequest request);
        partial void ProcessCreate3dStablePointAware3dResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreate3dStablePointAware3dResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> Create3dStablePointAware3dAsync(
            string contentType,
        ...
        {
            var __response = await Create3dStablePointAware3dAsResponseAsync(
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> Create3dStablePointAware3dAsStreamAsync(
            string contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreate3dStablePointAware3dArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_Create3dStablePointAware3dSecurityRequirements,
                operationName: "Create3dStablePointAware3dAsync");
            ...
            if (stabilityClientVersion != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("stability-client-version", stabilityClientVersion.ToString());
                            ...
                            if (request.TextureResolution != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.TextureResolution).HasValue ? (request.TextureResolution).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"texture_resolution\"");

                            }
                            if (request.ForegroundRatio != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.ForegroundRatio, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"foreground_ratio\"");

                            }
                            if (request.Remesh != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.Remesh).HasValue ? (request.Remesh).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"remesh\"");
                            ...
                            if (request.TargetCount != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.TargetCount, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"target_count\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreate3dStablePointAware3dRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "create3dStablePointAware3d",
                                methodName: "Create3dStablePointAware3dAsync",
                                pathTemplate: "\"/v2beta/3d/stable-point-aware-3d\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreate3dStablePointAware3dResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::StabilityAI.Create3dStablePointAware3dResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::StabilityAI.Create3dStablePointAware3dResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.Create3dStablePointAware3dResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                global::StabilityAI.Create3dStablePointAware3dResponse2? __value_413 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_413 = global::StabilityAI.Create3dStablePointAware3dResponse2.FromJson(__content_413, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.Create3dStablePointAware3dResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::StabilityAI.Create3dStablePointAware3dResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::StabilityAI.Create3dStablePointAware3dResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.Create3dStablePointAware3dResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::StabilityAI.Create3dStablePointAware3dResponse4? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::StabilityAI.Create3dStablePointAware3dResponse4.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.Create3dStablePointAware3dResponse4>.Create(
                                    statusCode: __response.StatusCode,
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<byte[]>> Create3dStablePointAware3dAsResponseAsync(
            string contentType,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreate3dStablePointAware3dResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> Create3dStablePointAware3dAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::StabilityAI.Create3dStablePointAware3dRequest
            {
                Image = image,
                Imagename = imagename,
            ...
            return await Create3dStablePointAware3dAsync(
                contentType: contentType,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
                stabilityClientVersion: stabilityClientVersion,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::StabilityAI.Create3dStablePointAware3dRequest
            {
