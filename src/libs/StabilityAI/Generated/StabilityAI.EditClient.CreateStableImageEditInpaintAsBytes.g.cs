...
namespace StabilityAI
{
    public partial class EditClient
    {
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> CreateStableImageEditInpaintAsBytesAsync(
            string contentType,
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateStableImageEditInpaintAsBytesAsStreamAsync(
            string contentType,
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<byte[]>> CreateStableImageEditInpaintAsBytesAsResponseAsync(
            string contentType,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageEditInpaintAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateStableImageEditInpaintAsBytesAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
