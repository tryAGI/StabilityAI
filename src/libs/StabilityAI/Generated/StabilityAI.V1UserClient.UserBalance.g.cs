...
namespace StabilityAI
{
    public partial class V1UserClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_UserBalanceSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_UserBalanceSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_UserBalanceSecurityRequirement0,
            };
        partial void PrepareUserBalanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? organization);
        partial void PrepareUserBalanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? organization);
        partial void ProcessUserBalanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUserBalanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.BalanceResponseBody> UserBalanceAsync(
            string? organization = default,
            global::StabilityAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UserBalanceAsResponseAsync(
        ...
        ///   -H "Authorization: Bearer $STABILITY_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.BalanceResponseBody>> UserBalanceAsResponseAsync(
            string? organization = default,
            global::StabilityAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UserBalanceSecurityRequirements,
                operationName: "UserBalanceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UserBalanceAsync",
                                pathTemplate: "\"/v1/user/balance\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw new global::StabilityAI.ApiException<global::StabilityAI.Error>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUserBalanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::StabilityAI.BalanceResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.BalanceResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::StabilityAI.BalanceResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
