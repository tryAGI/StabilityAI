...
namespace StabilityAI
{
    public partial class EditClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_CreateStableImageEditOutpaintAsBytesSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_CreateStableImageEditOutpaintAsBytesSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_CreateStableImageEditOutpaintAsBytesSecurityRequirement0,
            };
        partial void PrepareCreateStableImageEditOutpaintAsBytesArguments(
        ...
        partial void PrepareCreateStableImageEditOutpaintAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::StabilityAI.CreateStableImageEditOutpaintRequest request);
        partial void ProcessCreateStableImageEditOutpaintAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStableImageEditOutpaintAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> CreateStableImageEditOutpaintAsBytesAsync(
            string contentType,
        ...
        {
            var __response = await CreateStableImageEditOutpaintAsBytesAsResponseAsync(
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateStableImageEditOutpaintAsBytesAsStreamAsync(
            string contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStableImageEditOutpaintAsBytesArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStableImageEditOutpaintAsBytesSecurityRequirements,
                operationName: "CreateStableImageEditOutpaintAsBytesAsync");
            ...
            if (stabilityClientVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStableImageEditOutpaintAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createStableImageEditOutpaintAsBytes",
                                methodName: "CreateStableImageEditOutpaintAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateStableImageEditOutpaintAsBytesResponse(
                    httpClient: HttpClient,
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<byte[]>> CreateStableImageEditOutpaintAsBytesAsResponseAsync(
            string contentType,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageEditOutpaintAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateStableImageEditOutpaintAsBytesAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
