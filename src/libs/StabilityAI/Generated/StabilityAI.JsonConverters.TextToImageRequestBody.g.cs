...
{
    /// <inheritdoc />
    public class TextToImageRequestBodyJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::StabilityAI.TextToImageRequestBody>
    {
        /// <inheritdoc />
        public override global::StabilityAI.TextToImageRequestBody Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::StabilityAI.TextToImageRequestBodyVariant1? textToImageRequestBodyVariant1 = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::StabilityAI.TextToImageRequestBodyVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::StabilityAI.TextToImageRequestBodyVariant1> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::StabilityAI.TextToImageRequestBodyVariant1).Name}");
                        textToImageRequestBodyVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (textToImageRequestBodyVariant1 == null && generationOptionalParams == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::StabilityAI.TextToImageRequestBodyVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::StabilityAI.TextToImageRequestBodyVariant1> ??
            ...
            var __value = new global::StabilityAI.TextToImageRequestBody(
        ...
        public override void Write(
            ...
            global::StabilityAI.TextToImageRequestBody value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsTextToImageRequestBodyVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::StabilityAI.TextToImageRequestBodyVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::StabilityAI.TextToImageRequestBodyVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::StabilityAI.TextToImageRequestBodyVariant1).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TextToImageRequestBodyVariant1!, typeInfo);
            }
