...
namespace StabilityAI
{
    public partial class EditClient
    {
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement s_CreateStableImageEditEraseSecurityRequirement0 =
        ...
        private static readonly global::StabilityAI.EndPointSecurityRequirement[] s_CreateStableImageEditEraseSecurityRequirements =
            new global::StabilityAI.EndPointSecurityRequirement[]
            {                s_CreateStableImageEditEraseSecurityRequirement0,
            };
        partial void PrepareCreateStableImageEditEraseArguments(
        ...
        partial void PrepareCreateStableImageEditEraseRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::StabilityAI.CreateStableImageEditEraseRequest request);
        partial void ProcessCreateStableImageEditEraseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStableImageEditEraseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        ///     f"https://api.stability.ai/v2beta/stable-image/edit/erase",<br/>
        ///     headers={<br/>
        ///         "authorization": f"Bearer sk-MYAPIKEY",<br/>
        ///         "accept": "image/*"<br/>
        ///     },<br/>
        ///     files={<br/>
        ///         "image": open("./kangaroo-on-the-beach.png", "rb"),<br/>
        ///         "mask": open("./mask-of-kangaroo.png", "rb"),<br/>
        ///     },<br/>
        ///     data={<br/>
        ...
        ///     with open("./just-the-beach.webp", 'wb') as file:<br/>
        ///         file.write(response.content)<br/>
        /// else:<br/>
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.CreateStableImageEditEraseResponse> CreateStableImageEditEraseAsync(
            string contentType,
        ...
        {
            var __response = await CreateStableImageEditEraseAsResponseAsync(
        ...
        ///     raise Exception(str(response.json()))
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.CreateStableImageEditEraseResponse>> CreateStableImageEditEraseAsResponseAsync(
            string contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStableImageEditEraseArguments(
            ...
            var __authorizations = global::StabilityAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStableImageEditEraseSecurityRequirements,
                operationName: "CreateStableImageEditEraseAsync");
            ...
            if (stabilityClientVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStableImageEditEraseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::StabilityAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createStableImageEditErase",
                                methodName: "CreateStableImageEditEraseAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateStableImageEditEraseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageEditEraseResponse4>.Create(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageEditEraseResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageEditEraseResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::StabilityAI.ApiException<global::StabilityAI.CreateStableImageEditEraseResponse7>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStableImageEditEraseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::StabilityAI.CreateStableImageEditEraseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::StabilityAI.AutoSDKHttpResponse<global::StabilityAI.CreateStableImageEditEraseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::StabilityAI.CreateStableImageEditEraseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateStableImageEditEraseAsync(
                contentType: contentType,
                accept: accept,
                stabilityClientId: stabilityClientId,
                stabilityClientUserId: stabilityClientUserId,
                    ...
                    await global::StabilityAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::StabilityAI.CreateStableImageEditEraseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::StabilityAI.CreateStableImageEditEraseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
